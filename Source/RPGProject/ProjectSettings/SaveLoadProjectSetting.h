...
#include "Public/SaveSystem/InfoSaveGame.h"
#include "SaveLoadProjectSetting.generated.h"

/**
 * 
 */
UCLASS(config=Engine, defaultconfig)
class RPGPROJECT_API USaveLoadProjectSetting : public UObject
{
	GENERATED_BODY()
	...
	UPROPERTY(config, EditAnywhere, Category = "General Settings", meta = (MetaClass = "/Script/RPGProject.InfoSaveGame", DisplayName = "Slot Info Class"))
	...
	*/
	UPROPERTY(config, EditAnywhere, Category = "Save and Load", meta = (DisplayName = "Multi-Level Saving"))
	...
	*/
	...
	static FORCEINLINE USaveLoadProjectSetting* Get()
	{
		USaveLoadProjectSetting* Settings = GetMutableDefault<USaveLoadProjectSetting>();
		check(Settings);
