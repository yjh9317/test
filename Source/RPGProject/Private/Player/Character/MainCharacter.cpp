...
void AMainCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UCustomInputComponent* CustomInputComponent = CastChecked<UCustomInputComponent>(PlayerInputComponent))
	{
		...
		CustomInputComponent->BindNativeInputAction(InputConfigDataAsset,RPGGameplayTags::Shared_Input_Move,ETriggerEvent::Triggered,this,&ThisClass::HandleGroundMovementInput);
		CustomInputComponent->BindNativeInputAction(InputConfigDataAsset,RPGGameplayTags::Shared_Input_Look,ETriggerEvent::Triggered,this,&ThisClass::Look);
		
		CustomInputComponent->BindNativeInputAction(InputConfigDataAsset,RPGGameplayTags::Shared_Input_Jump,ETriggerEvent::Triggered,this,&ACharacter::Jump);
		CustomInputComponent->BindNativeInputAction(InputConfigDataAsset,RPGGameplayTags::Shared_Input_Jump,ETriggerEvent::Completed,this,&ACharacter::StopJumping);

		CustomInputComponent->BindNativeInputAction(InputConfigDataAsset,RPGGameplayTags::Shared_Input_LeftClick,ETriggerEvent::Triggered,this,&AMainCharacter::HandleLeftClickInput);
		CustomInputComponent->BindNativeInputAction(InputConfigDataAsset,RPGGameplayTags::Shared_Input_RightClick,ETriggerEvent::Triggered,this,&AMainCharacter::HandleRightClickInput);
		
		CustomInputComponent->BindNativeInputAction(InputConfigDataAsset,RPGGameplayTags::Shared_Input_ClimbMove,ETriggerEvent::Triggered,this,&ThisClass::HandleClimbMovementInput);
		CustomInputComponent->BindNativeInputAction(InputConfigDataAsset,RPGGameplayTags::Shared_Input_ClimbAction,ETriggerEvent::Started,this,&ThisClass::OnClimbActionStarted);
		CustomInputComponent->BindNativeInputAction(InputConfigDataAsset,RPGGameplayTags::Shared_Input_ClimbHop,ETriggerEvent::Started,this,&ThisClass::OnClimbHopActionStarted);
		CustomInputComponent->BindNativeInputAction(InputConfigDataAsset,RPGGameplayTags::Shared_Input_Grapple,ETriggerEvent::Started,this,&ThisClass::GrappleUse);
		CustomInputComponent->BindNativeInputAction(InputConfigDataAsset,RPGGameplayTags::Shared_Input_TargetLock,ETriggerEvent::Started,this,&ThisClass::StartTargetSystem);
	}
}
...
void AMainCharacter::StartTargetSystem()
{
}
