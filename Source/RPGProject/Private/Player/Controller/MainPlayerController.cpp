...
void AMainPlayerController::SetupInputComponent()
{
	...
	{
		CustomInputComponent->BindNativeInputAction(InputConfigDataAsset,RPGGameplayTags::Shared_Input_Inventory,ETriggerEvent::Completed,this,&ThisClass::OpenInventoryWidget);
		CustomInputComponent->BindNativeInputAction(InputConfigDataAsset,RPGGameplayTags::Shared_Input_Interact,ETriggerEvent::Started,this,&ThisClass::InputInteraction);
	}
}
