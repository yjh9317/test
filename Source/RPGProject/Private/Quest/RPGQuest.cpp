...
URPGQuest::URPGQuest()
{
	QuestData = CreateDefaultSubobject<UQuestItemData>(TEXT("QuestData"));
}
...
void URPGQuest::SetQuestData(UQuestItemData* _QuestData)
{
	QuestData = DuplicateObject<UQuestItemData>(_QuestData, this);
