...
public:
	...
	//
	// UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "Component Manager")
	// UStationsManager* GetStationsManagerComponent();
	// virtual UStationsManager* GetStationsManagerComponent_Implementation() {return nullptr;}
	//
	// UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "Component Manager")
	...
	virtual UStationsManager* GetStationsManagerComponent() {return nullptr;}
