...
#include "Quest/Data/QuestItemData.h"
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnStateChangedDelegate, EQuestState, QuestState);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnSleepStateChangedDelegate, bool, bIsComponentSilent);
...
public:
	...
	void SetQuestMarker(bool isMarkerVisible, bool isQuestValid, EQuestType QuestState = EQuestType::EQT_MainQuest);
