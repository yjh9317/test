...
public:
	...
	int CheckInventoryForItem(FObjectives currentObjective);	// This is implemented in blueprint 
	
	UFUNCTION(BlueprintCallable, BlueprintImplementableEvent, Category = "Advanced Quest | Quest")
	int CheckForPlayerStats(FObjectives currentObjective);	// This is implemented in blueprint 
