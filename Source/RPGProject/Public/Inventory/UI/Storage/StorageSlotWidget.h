...
private:
    ...
    TObjectPtr<UItemDragAndDropWidget> ItemDragAndDropWidgetRef;
    
    UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category="Class", meta=(AllowPrivateAccess="true"))
    TSubclassOf<UItemDragAndDropWidget> ItemDragAndDropWidgetClass;

    UPROPERTY(BlueprintReadOnly, Category="Reference", meta=(AllowPrivateAccess="true"))
    TObjectPtr<UItemDataDragDropOperation> ItemDataDragAndDropOperationRef;
    ...
    UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category="Default", meta=(AllowPrivateAccess="true"))
    FLinearColor ImageItemUsedColor = FLinearColor{0.223228f, 0.219526f, 0.212231f, 1.f};
    
    UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category="Default", meta=(AllowPrivateAccess="true"))
    FLinearColor ImageItemUnusedColor = FLinearColor{1.f, 1.f, 1.f, 1.f};
