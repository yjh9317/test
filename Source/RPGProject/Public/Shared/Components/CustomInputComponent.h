...
// template <class UserObject, typename CallbackFunc>
// void UCustomInputComponent::BindAbilityInputAction(const UDataAsset_InputConfig* InInputConfig,
// 	UserObject* ContextObject, CallbackFunc InputPressedFunc, CallbackFunc InputRelasedFunc)
// {
// 	checkf(InInputConfig,TEXT("Input config data asset is null,can not proceed with binding"));
// 	for (const FCustomInputActionConfig& AbilityInputActionConfig : InInputConfig->AbilityInputActions)
// 	{
